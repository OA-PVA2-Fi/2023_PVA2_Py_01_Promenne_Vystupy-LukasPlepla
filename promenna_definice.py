# V komentáři máte pospáno zadání úlohy.
...
message = # Nová hodnota
print("message = " + str(message))


# Deklarujte promměnou Jméno. Hodnota proměnné bude Vaše jméno.
? # Deklarujte celý řádek
print("jmeno = " + str(jmeno))


# Zřetězené přiřazení
a # Proměnné "a" a "b" přiřaďte hodnotu 2
print("a = " + str(a))
print("b = " + str(b))


# Doplňte příkazy print tak, aby se zobrazil text "dum muj dum"
